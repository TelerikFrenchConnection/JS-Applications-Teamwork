...
inheritFrom(core.Event, core.UIEvent, {initUIEvent: function(type, bubbles, cancelable, view, detail) {
...
inheritFrom(core.UIEvent, core.MouseEvent, {initMouseEvent: function(type, bubbles, cancelable, view, detail, screenX, screenY, clientX, clientY, ctrlKey, altKey, shiftKey, metaKey, button, relatedTarget) {
...
function mutationEventsEnabled(el) {
  return el.nodeType != NODE_TYPE.ATTRIBUTE_NODE && getDocument(el).implementation._hasFeature('MutationEvents');
}
...
var interfaceTable = {
  ...
  customevent: core.Event,
  keyboardevent: core.Event,
  keyevents: core.Event,
  touchevent: core.Event,
...
core.Document.prototype.createEvent = function(type) {
  ...
  if (!Constructor) {
    throw new core.DOMException(core.DOMException.NOT_SUPPORTED_ERR, "The provided event type (\"" + type + "\") is invalid");
  }
